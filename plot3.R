...
## Plot 3. Scatterplot of datetime versus Sub_metering_x

#open up graphic file png
png(filename = "plot3.png", width = 480, height = 480, units = "px")

#create the plot of "datetime" versus "Sub_metering_1" followed by each of the other two
#note: the following code will produce the same chart but without the three differentiating colors
#with(mydata, plot(x = c(datetime, datetime, datetime), y = c(Sub_metering_1, Sub_metering_2, Sub_metering_3), col = c("black", "red", "blue"), type = "l", pch = "15", xlab = "", ylab = "Energy sub metering"))
